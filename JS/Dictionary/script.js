...
function displayRecentWord() {
    ...
    recentWord.forEach(function (element, index) {
        ...
        html += `<div class="recent_word my-2 mx-2 card" style="width: auto">
        <div class="card-body">
           <button id ="recent_popover" type="button" class="btn py-0 px-0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="bottom" title="${element.title}"
            data-bs-content="${element.meaning}"> <h5 class="card_title">${element.title}</h5>
        </button>
            </div>
    </div>`;
